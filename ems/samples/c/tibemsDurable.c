/* 
 * Copyright (c) 2001-$Date: 2017-05-04 12:04:05 -0500 (Thu, 04 May 2017) $ TIBCO Software Inc. 
 * Licensed under a BSD-style license. Refer to [LICENSE]
 * For more information, please contact:
 * TIBCO Software Inc., Palo Alto, California, USA
 * 
 * $Id: tibemsDurable.c 93262 2017-05-04 17:04:05Z krailton $
 * 
 */
...
void usage() 
{
    ...
    printf(" -clientID <client-id>  - connection client ID, default is null\n");
    printf(" -durable  <durable>    - durable name, default is \"subscriber\"\n");
    printf(" -unsubscribe           - unsubscribe and quit\n");
