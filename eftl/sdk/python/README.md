...
However, the field data types within eFTL messages are not similar to those in EMS messages. For details of message translation, see “Message Translation: TIBCO eFTL and TIBCO EMS” in TIBCO eFTL Concepts (https://docs.tibco.com/pub/eftl/6.10.0/doc/pdf/TIB_eftl_6.10.0_concepts.pdf).

## Installation
The eFTL python library is hosted on PyPI and can be installed with `pip3 install eftl`

## Documentation
https://docs.tibco.com/pub/eftl/6.10.0/doc/html/api-reference/python/connection.html
...
https://docs.tibco.com/products/tibco-ftl-enterprise-edition-6-10-0 (FTL), and
https://docs.tibco.com/products/tibco-eftl-enterprise-edition-6-10-0 (eFTL).
