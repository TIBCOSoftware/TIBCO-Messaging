...
/*
 * This is a sample of a basic eFTL program which gets
 * a key/value pair from a map.
 */

public class KVGet extends Thread {
    ...
    public void printUsage() {
        ...
        System.out.println();
        System.out.println("usage: MapGet [options] url");
        System.out.println();
    ...
    public void run() {
        ...
        EFTL.connect(url, props, new ConnectionListener() {
            ...
            public void onConnect(Connection connection) {
                ...
                connection.createKVMap(map).get(key, new KVMapListener() {

                    @Override
                    public void onSuccess(String key, Message value) {

                        System.out.printf("Get map='%s' key='%s' value=%s\n", map, key, value);
                    ...
                    public void onError(String key, Message value, int code, String reason) {
                        ...
                        System.out.printf("ERROR: Get map='%s' key='%s': %s\n", map, key, reason);
