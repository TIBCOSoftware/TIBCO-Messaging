...
/*
 * This is a sample of an eFTL last-value durable program 
 * which subscribes to the specified destination and receives 
 * the requested messages.
 */

public class LastValueDurable extends Thread {
    
    String url = "ws://localhost:9191/channel";
    String username = null;
    String password = null;
    String destination = "sample";
    String durableName = "sample-last-value";
    String trustStoreFilename = null;
    String trustStorePassword = "";
    
    public LastValueDurable(String[] args) {
    ...
    public void printUsage() {
        ...
        System.out.println();
        System.out.println("usage: LastValueDurable [options] url");
        System.out.println();
    ...
    public void subscribe(final Connection connection) {
        ...
        //
        // The durable type is being set to last-value.
        //
        // The durable key defines on which field in the content
        // matcher the messages will be sorted.
        //
        props.setProperty(EFTL.PROPERTY_DURABLE_TYPE, EFTL.DURABLE_TYPE_LAST_VALUE);
        props.setProperty(EFTL.PROPERTY_DURABLE_KEY, "_dest");
    ...
    public static void main(String[] args) {
        ...
        try {
            new LastValueDurable(args).start();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    }
