...
public class KVSet {
    ...
    public static String text = "this is sample eFTL text";

    private static void Usage () {
        Console.WriteLine ();
        Console.WriteLine ("usage: KVSet [options] url");
        Console.WriteLine ();
    ...
    public class KVMapListener : IKVMapListener {
        ...
        public void OnSuccess (String key, IMessage value) {
            Console.WriteLine ("\nSuccess setting key-value pair {0} = {1}\n", key, value);
        ...
        public void OnError (String key, IMessage value, int code, String reason) {
            Console.WriteLine ("\nError setting key-value pair: {0}\n", reason);
    ...
    public KVSet (String url, String username, String password) {
    ...
    public static void Main (string[] args) {
        ...
        try {
            new KVSet (url, username, password);
        } catch (Exception e) {
